...
/**
 * This class represents an EmailNotification Entity in our domain.
 *
 * @property id The unique identifier of the EmailNotification. Instances of [EntityId].
 ...
 * @property recipient The recipient of the email notification, represented by [Recipient] instances.
 * @property createdAt The date when the EmailNotification was created. Defaults to the current date and time.
 * @property updatedAt The date when the EmailNotification was last updated. Defaults to the current date and time.
 * @property dispatcher The [EventDispatcher] used to manage events associated with the EmailNotification.
 */
